...
import { ReactComponent as LinkIcon } from '../assets/icons/navigation-nav.svg';
import { ReactComponent as CameraIcon } from '../assets/icons/camera-nav.svg';
import { ReactComponent as EyeIcon } from '../assets/icons/autofocus-nav.svg';
import { ReactComponent as ListBulletIcon } from '../assets/icons/sequence-nav.svg';
import { ReactComponent as Cog6ToothIcon } from '../assets/icons/settings-nav.svg';
import { ReactComponent as LightBulbIcon } from '../assets/icons/flatpanel-nav.svg';
import { ReactComponent as AdjustmentsVerticalIcon } from '../assets/icons/guiding-nav.svg';
import { ReactComponent as SparklesIcon } from '../assets/icons/target.svg';

const NavigationComp = () => {
  return (
    <div className="flex top-0 shadow-md overflow-hidden justify-center h-20">
      <div
      ...
      >
        <div className="flex space-x-2 px-2" style={{ scrollSnapAlign: 'start' }}>
          <NavLink to="/equipment" className="nav-button" activeClassName="active-nav-button" title="Equipment">
            <LinkIcon className="icon" />
          </NavLink>
          <NavLink to="/camera" className="nav-button" activeClassName="active-nav-button" title="Camera">
            <CameraIcon className="icon" />
          </NavLink>
          <NavLink to="/autofocus" className="nav-button" activeClassName="active-nav-button" title="Autofocus">
            <EyeIcon className="icon" />
          </NavLink>
          <NavLink to="/mount" className="nav-button" activeClassName="active-nav-button" title="Mount">
            <svg
          ...
          <NavLink to="/dome" className="nav-button" activeClassName="active-nav-button" title="Dome">
            <svg
              fill="#FFFFFF"
              height="24"
              width="24"
            ...
            >
              ...
              <path
                ...
                c0,4.512,3.658,8.17,8.17,8.17s8.17-3.658,8.17-8.17v-13.617h49.021v13.617c0,4.512,3.658,8.17,8.17,8.17
          ...
          <NavLink to="/flat" className="nav-button" activeClassName="active-nav-button" title="Flat">
            <LightBulbIcon className="icon" />
          </NavLink>
          <NavLink to="/switch" className="nav-button" activeClassName="active-nav-button" title="Switch">
            <AdjustmentsVerticalIcon className="icon" />
          </NavLink>
          <NavLink to="/guider" className="nav-button" activeClassName="active-nav-button" title="Guider">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <NavLink to="/sequence" className="nav-button" activeClassName="active-nav-button" title="Sequence">
            <ListBulletIcon className="icon" />
          </NavLink>
          <NavLink to="/flats" className="nav-button" activeClassName="active-nav-button" title="Flats">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <NavLink to="/seq-mon" className="nav-button" activeClassName="active-nav-button" title="Sequence Monitoring">
            <svg
              fill="#FFFFFF"
              height="400px"
              width="400px"
          ...
          <NavLink to="/" className="nav-button" activeClassName="active-nav-button" title="Home">
